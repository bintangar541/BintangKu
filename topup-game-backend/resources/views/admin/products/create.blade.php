                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            placeholder="Contoh: 1000 Diamonds" value="{{ old('name') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror"
                            placeholder="Contoh: ML-1000D" value="{{ old('sku') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="price_modal"
                                    ...
                                    value="{{ old('price_modal', 0) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="price_sell"
                                    ...
                                    value="{{ old('price_sell', 0) }}" required>
